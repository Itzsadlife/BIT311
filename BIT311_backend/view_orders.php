...
$sql = "SELECT orders.orderID, products.productName, orders.amount, products.productID FROM orders INNER JOIN products ON orders.productID = products.productID WHERE orders.userID = '$userID'";
